"""
Provides a function for weaving a Hamiltonian Cycle of a Manhattan Ball of n layers including core.
...
Note: The module depends modules from the 'src.weaver' package for additional functionality.
...
@profile()
def weave(n_level: int) -> Solution:
    """Weave a Hamiltonian Cycle of a Manhattan Ball of n layers including the core cube.
